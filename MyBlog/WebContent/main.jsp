...
%>
 ...
 <div class="container">
 	<div class="jumbotron">
 		<div class="container">
 			<h1>웹 사이트 소개</h1>
 			<p>이 웹 사이트는 부트스트랩으로 만든 JSP 웹 사이트 입니다. 최소한의 간단한 로직만을 이용해 개발했습니다. 디자인 템플릿으로는 부트스트랩을 사용했습니다"</p>
 	...
 	<div id="myCarousel" class="carousel slide" data-ride="carousel">
 		...
 		<div class="carousel-inner">
 			<div class="item active">
 				<img src="images/밤하늘.png">
 			</div>
 			<div class="item">
 				<img src="images/해변.png">
 			</div>
 			<div class="item">
 				<img src="images/해저동굴.png">
 			</div>
 		</div>
